...
<div class="row">
  ...
  <div class="row">
        ...
        <!------- W3 animacija za prekaz slike u stvanoj veličini ----------->
            ...
            <div class="w3-row-padding">
                <div class="w3-container w3-third">
                    ...
                    <img src="images/luka.jpg" style="width: 200px; height: 200px; object-fit: cover; cursor:pointer" 
    ...
    <div class="col-sm-6">
      ...
      <h5>Dario Mendeš:</h5>
        ...
        <div class="w3-container">
                    ...
                    <div class="w3-row-padding">
                        <div class="w3-container w3-third">
                            <!------- samo dodaš sliku u images po nazovim dario.jpg ----------->
                            <img src="images/dario.jpg" style="width: 200px; height: 200px; object-fit: cover; cursor:pointer" 
                            onclick="onClick(this)" class="w3-hover-opacity">
                        </div>
                    </div>
                ...
                <!------- KRAJ: W3 animacija za prekaz slike u stvanoj veličini ----------->
                <p>Darijevi omiljeni filmovi su...</p>
      ...
      <li class="nav-item">
            <p class="zivot-tekst">Mjesto i datum rođenja:</p>
            <a class="zivot-link"  href="https://www.virovitica.hr" target="_blank" >&nbsp;&#9733;Grad</a>
            <p>&nbsp;&nbsp; 22.04.1997</p>
        ...
        <li class="nav-item">
            <p class="zivot-tekst">Školovanje:</p>
            <a class="zivot-link"  href="http://os-vnazora-daruvar.skole.hr" target="_blank" >&nbsp;&#9733;Osnovna škola </a>
            <br><br>
        </li>
        <li class="nav-item">
            <p class="zivot-tekst">Stručno obrazovanje:</p>
            <a class="zivot-link"  href="https://www.tsd.hr/site/" target="_blank" >&nbsp;&#9733;Tehnička / Gimnazija</a>
            <p>&nbsp;&nbsp; Tehničar za raučunarstvo</p>
        </li>
        <li class="nav-item">
            <p class="zivot-tekst">Visoko obrazovanje::</p>
